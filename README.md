...
![Intermediate](https://img.shields.io/badge/difficulty-intermediate-F59E0B) ![Computer Vision](https://img.shields.io/badge/course-Computer%20Vision-0056CE) ![16 hours](https://img.shields.io/badge/estimated-16h-lightgrey)

> **Square 1 AI** starter template — Computer Vision

## Overview

In this intermediate-level project, you'll build a **Face Recognition System** using Python, FaceNet, dlib. Build a face recognition attendance system using deep learning embeddings. This is a hands-on project where you'll write real code, solve real problems, and build something you can showcase in your portfolio.

This project is part of the **Computer Vision** course, where you'll build systems that can see, understand, and process visual information.
...
```bash
# Clone this template
git clone https://github.com/nikhildesilva-squareai/starter-face-recognition-system.git
cd starter-face-recognition-system
...
This project builds skills directly applicable to roles like: **Computer Vision Engineer, ML Engineer, Perception Engineer**.
